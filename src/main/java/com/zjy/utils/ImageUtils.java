...
public class ImageUtils {
	...
	public static void main(String[] args) {
		...
		// 2-切割图像：
		// 方法一：按指定起点坐标和宽高切割
		//ImageUtils.cut("e:/abc.jpg", "e:/abc_cut.jpg", 0, 0, 100, 200);
		// 方法二：指定切片的行数和列数
		...
		// 5-给图片添加文字水印：
		// 方法一：
		//ImageUtils.pressText("我是水印文字", "e:/abc.jpg", "e:/abc_pressText.jpg","宋体", Font.BOLD, Color.white, 50, 0, 0, 0.5f);
		// 方法二：
		//ImageUtils.pressText2("我也是水印文字", "e:/abc.jpg", "e:/abc_pressText2.jpg", "黑体", 36, Color.white, 50, 0, 0, 0.5f);

		// 6-给图片添加图片水印：
		//ImageUtils.pressImage("e:/abc2.jpg", "e:/abc.jpg", "e:/abc_pressImage.jpg", 50, 50, 0.5f);
